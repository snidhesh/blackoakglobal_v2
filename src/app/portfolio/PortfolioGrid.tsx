...
function DealCard({ deal }: { deal: Deal }) {
  return (
    ...
    >
      <Link href={`/portfolio/${deal.slug}`} className="group block">
        <div className="relative aspect-[4/5] overflow-hidden">
          <Image
            ...
            className="object-cover grayscale-[15%] transition-all duration-[900ms] group-hover:grayscale-0 group-hover:scale-[1.02]"
          />
        ...
        <div className="mt-6 flex items-center justify-between">
          <div className="flex items-center gap-3 text-[10.5px] uppercase tracking-[0.2em] text-[var(--color-muted)]">
          ...
          <ArrowUpRight
            size={16}
            strokeWidth={1.5}
            className="text-[var(--color-ink)] transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5"
          />
        </div>
      </Link>
    </motion.div>
